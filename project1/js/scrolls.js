...
$(document).ready(function(e){
    $("body,html").animate({scrollTop:0 , marginLeft:0},100, "easeInOutQuad");
...
$("nav a[href^='#']").click(function(e){
    ...
    $("body,html").animate({scrollTop:idPosNav , marginTop:10}, 1000, "easeInOutQuad");
});
...
$(window).scroll(function(){
    ...
    $("section").each(function(){
        ...
        //  to check what section is currently visible in the viewport
    ...
    $(".revealElement").each(function(){
        ...
        if(bottomOfObject<bottomOfWindow){
            $(this).animate({opacity:1, marginLeft:100}, 3000, "easeOutBack");
        }
    });
});
...
$("#intro img").delay(400).animate(
    {opacity:1, marginLeft:100 , marginTop:100},
    2000,
    "easeOutBounce"
);
...
$("#ham").click(function(){
    $(this).attr("src","images/hamburger.gif");
    $("#hamtext").html("click here to reset");
});

$("#hamtext").click(function(){
    $("#ham").attr("src","images/hamrev.gif");
    $(this).html("click on image to start");
});